...
describe('HomeV2Component', () => {
  ...
  const buildHomeSection = () => [
    {
      ...
      pills: [
        ...
        { pillKey: 'p2', pillInfoCountKey: 'countB', visibilityMode: 'visible' },
      ],
    },
  ]
  ...
  describe('loadPillsSectionInfo', () => {
    ...
    it('should not call the info API when every pill is hidden', () => {
      mockRoute.snapshot.data.home.data.homeSection[0].pills = [
    ...
    it('should keep only the visible pills before requesting the info API', () => {
      mockRoute.snapshot.data.home.data.homeSection[0].pills = [
        { pillKey: 'p1', pillInfoCountKey: 'countA', visibilityMode: 'visible' },
        { pillKey: 'p2', pillInfoCountKey: 'countB', visibilityMode: 'hidden' },
      ]
      mockHomePageSvc.getUserContentInfo.mockReturnValue(of({ result: { countA: 3 } }))
